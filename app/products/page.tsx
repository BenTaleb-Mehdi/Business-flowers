...
export default function ProductsPage() {
  ...
  return (
    // 1. On remplace la div principale par une balise <main> avec min-h-screen
    <main className="relative min-h-screen">

      {/* ── BACKGROUND FIXE (Zewa9a Royal identique à l'accueil) ── */}
      ...
      {/* ── CONTENU DE LA PAGE (J'ai enlevé le bg-white d'ici) ── */}
